...
export const debugScenarios: AiaiScenarioDefinition[] = [
  {
    ...
    steps: [
      ...
      { title: '장소 추천 표시', description: '가까운 휴식 장소 추천 결과를 보여줍니다.', actionLabel: '장소 추천 열기', agentSpeech: '신탄진 졸음쉼터를 찾았습니다. 현재 경로에서 21.4km 거리이고 18분 뒤 도착할 수 있습니다.' },
      { title: '사용자 음성 선택', description: '운전자가 추천 장소 안내를 승인합니다.', userSpeech: '응, 그곳으로 안내해줘' },
      { title: '경로 변경', description: '신탄진 졸음쉼터로 안내합니다.', actionLabel: '경로 변경', agentSpeech: '신탄진 졸음쉼터로 안내를 시작합니다.' },
  ...
  },
  {
    ...
    steps: [
      ...
      { title: '장소 추천 표시', description: '경로 인근 장소 추천을 보여줍니다.', actionLabel: '장소 추천 열기', agentSpeech: '경부고속도로 부산방향의 죽암휴게소를 찾았습니다. 잠시 쉬어가기 좋은 위치입니다.' },
      { title: '사용자 음성 선택', description: '운전자가 휴게소 안내를 승인합니다.', userSpeech: '응, 죽암휴게소로 안내해줘' },
      { title: '경로 변경', description: '죽암휴게소로 안내합니다.', actionLabel: '경로 변경', agentSpeech: '죽암휴게소로 안내를 시작합니다.' },
